    ...
    where TKey : notnull
{
  ...
  public BaseService(SiteContext dbContext, ClaimsPrincipal principal, IServiceProvider serviceProvider, ILogger<BaseService<TEntity, TKey>> logger) : base(dbContext, principal, serviceProvider, logger)
  {
  }
  #endregion
  ...
  public virtual TEntity Update(TEntity entity)
  {
    ...
    if (entry.State == EntityState.Detached && entity is Auditable audit)
    {
      ...
      var original = (Auditable?)this.Context.Find(typeof(TEntity), values);
      if (original != null)
      {
