...
public class UserService : BaseService<User, long>, IUserService
{
  ...
  public UserService(SiteContext dbContext, ClaimsPrincipal principal, IServiceProvider serviceProvider, ILogger<BaseService<User, long>> logger) : base(dbContext, principal, serviceProvider, logger)
  {
  }
  #endregion
