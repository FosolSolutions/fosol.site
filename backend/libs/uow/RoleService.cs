...
public class RoleService : BaseService<Role, long>, IRoleService
{
  ...
  public RoleService(SiteContext dbContext, ClaimsPrincipal principal, IServiceProvider serviceProvider, ILogger<BaseService<Role, long>> logger) : base(dbContext, principal, serviceProvider, logger)
  {
  }
  #endregion
