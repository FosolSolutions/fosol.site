...
public static class ServiceCollectionExtensions
{
  #region Methods
  /// <summary>
  /// Add SiteContext to services collection.
  ...
  /// <returns></returns>
  public static IServiceCollection AddSiteContext(this IServiceCollection services, IConfiguration config, Action<DbContextOptionsBuilder>? options = null, IHostEnvironment? env = null)
  {
    return services.AddDbContext<SiteContext>(opt =>
    {
