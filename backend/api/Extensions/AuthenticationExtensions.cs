...
namespace Fosol.Site.Api.Extensions;
...
public static class AuthenticationExtensions
{
  ...
  public static IServiceCollection AddSiteAuthentication(this IServiceCollection services, IConfiguration configuration)
  {
    ...
    var config = configuration.GetSection("Authentication").Get<SiteAuthenticationOptions>() ?? throw new ConfigurationErrorsException("Authentication section is required.");
    services.Configure<SiteAuthenticationOptions>(configuration.GetSection("Authentication"));
